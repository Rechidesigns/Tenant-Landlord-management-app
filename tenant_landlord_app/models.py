...
STATUS_CHOICES =(
    ...
    ('one bedroom flat', 'One bedrooms flat'),
    ('two bedroom flat', 'Two beedroom flat'),
    ('three bedroom flat', 'Three beedroom flat'),
    ('four bedroom flat', 'Four beedroom flat'),
    ('five bedroom flat', 'Five beedroom flat'),
    ('six bedroom flat', 'Six beedroom flat'),
    ('duplex', 'Duplex'),
