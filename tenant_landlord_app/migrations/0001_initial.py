    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('house_type', models.CharField(choices=[('single room', 'Single Room'), ('room self contain', 'Room self contain'), ('room and palor', 'Room and palor'), ('one bedroom flat', 'One bedrooms flat'), ('two bedroom flat', 'Two beedroom flat'), ('three bedroom flat', 'Three beedroom flat'), ('four bedroom flat', 'Four beedroom flat'), ('five bedroom flat', 'Five beedroom flat'), ('six bedroom flat', 'Six beedroom flat'), ('duplex', 'Duplex'), ('appartment', 'Appartment')], default='appartment', max_length=200)),
