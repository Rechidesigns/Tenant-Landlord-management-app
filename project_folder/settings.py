...
DEFAULT_FROM_EMAIL = 'King from landlord tenant management<noreply@landlordtenantmanagement.com>'

SITE_NAME = 'landlord tenant management software'

DOMAIN = 'landlordtenantmanagement.com'
